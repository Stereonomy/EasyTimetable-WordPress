jQuery(document).ready(function($) {
	...
	jQuery('#ulformlistplanning').find('li').each(function(){
		var id = jQuery(this).attr('data-form');
		jQuery('#et_duplicate_planning_'+id).on('click', function(e){
			e.preventDefault();
			var p_name = jQuery(this).attr('data-name');
			var time_mode = jQuery(this).attr('data-time-mode');
			var type = jQuery(this).attr('data-type');
			var display_title = jQuery(this).attr('data-display-title');
			var display_filters = jQuery(this).attr('data-display-filters');
			var start_h = jQuery(this).attr('data-start-h');
			var rows = jQuery(this).attr('data-rows');
			var rows_name = jQuery(this).attr('data-rows-name');
			var cells = jQuery(this).attr('data-cells');
			var cell_color = jQuery(this).attr('data-cell-color');
			var height = jQuery(this).attr('data-height');
			var description = jQuery(this).attr('data-description');
			var activities = jQuery(this).attr('data-activities');
			var scheduledact = jQuery(this).attr('data-scheduledact');
			var days = jQuery(this).attr('data-days');
			var print = jQuery(this).attr('data-print');
			var created_by = jQuery(this).attr('data-created-by');
			var access = jQuery(this).attr('data-access');
			var nonce = jQuery(this).attr('data-nonce');
			var datas = {
				'action': 'syet_duplicate_planning',
				'p_name': p_name,
				'time_mode': time_mode,
				'type': type,
				'display_title': display_title,
