...
class EasyTimetableViewCreate {
				...
				<form id="newone" method="POST" action="">
					...
					<div class="forminput">
						...
						<select id="type" name="type">
							...
							<option value="0" disabled><?php _e( 'Adaptative', 'easytimetable-responsive-schedule-management-system' ); ?></option>
						</select>
					</div>
					<div class="forminput">
						<div class="labeldecadix">
					...
					<div class="forminput">
						...
						<input id="rows" type="number" name="rows"  placeholder="columns" value="5">
					</div>
					<div class="forminput">
						<div class="labeldecadix">
							<label for="cells"><?php _e( 'Cells', 'easytimetable-responsive-schedule-management-system' ); ?></label>
						</div>
						<input id="cells" type="number" name="cells" placeholder="Cells" value="8">
					</div>
					<div class="forminput">
						<div class="labeldecadix">
					...
					<div class="forminput cellcolor">
						...
						<input id="cell_color" type="text" name="cell_color" value="e5e5e5">
					</div>
					<div class="forminput">
						<div class="labeldecadix">
							<label for="rows_name"><?php _e( 'Custom column names', 'easytimetable-responsive-schedule-management-system' ); ?></label>
						</div>
						<textarea form="newone" id="rows_name" name="rows_name" title="<?php _e( 'Leave empty to use the date system and the name of the days in the language of the site', 'easytimetable-responsive-schedule-management-system' ); ?>" placeholder="<?php _e( 'Enter names separated by comma', 'easytimetable-responsive-schedule-management-system' ); ?>"></textarea>
					</div>
	...
	?>
			...
			<h1><?php printf(__( 'EasyTimetable - Edit Timetable - %s', 'easytimetable-responsive-schedule-management-system' ), $data[0]->p_name); ?></h1>
			...
			<div class="sy-form-container">
				...
				<form id="newone" name="newone" method="POST" action="">
					<input id="planning_id" type="hidden" name="planning_id" value="<?php echo $data[0]->id ?>">
					<input id="creation_date" type="hidden" name="creation_date" value="<?php echo $data[0]->creation_date ?>">
					<div class="forminput">
						<div class="labeldecadix">
							<label  for="p_name"><?php _e( 'Title', 'easytimetable-responsive-schedule-management-system' ); ?></label>
						</div>
					...
					<div class="forminput">
						...
						<select id="display_filters" name="display_filters">
							<?php if( $data[0]->display_filters == 0): ?>
								<option value="0" selected><?php _e( 'No', 'easytimetable-responsive-schedule-management-system' ); ?></option>
								<option value="1"><?php _e( 'Yes', 'easytimetable-responsive-schedule-management-system' ); ?></option>
							<?php else: ?>
								<option value="0"><?php _e( 'No', 'easytimetable-responsive-schedule-management-system' ); ?></option>
					...
					<div class="forminput">
						...
						<input id="rows" type="number" name="rows" value="<?php echo $data[0]->rows ?>">
					</div>
					<div class="forminput">
						<div class="labeldecadix">
							<label for="cells"><?php _e( 'Cells', 'easytimetable-responsive-schedule-management-system' ); ?></label>
						</div>
						<input id="cells" type="number" name="cells" value="<?php echo $data[0]->cells ?>">
					</div>
					<div class="forminput">
						<div class="labeldecadix">
							<label for="cell_color"><?php _e( 'Cell color', 'easytimetable-responsive-schedule-management-system' ); ?></label>
						</div>
						<input id="cell_color" type="text" name="cell_color" value="<?php echo $data[0]->cell_color ?>">
					</div>
					...
					<div class="forminput">
						...
						<input id="height" type="number" min="50" name="height" value="<?php echo $data[0]->height ?>">
					</div>
					<div class="forminput">
						<div class="labeldecadix">
							<label for="print"><?php _e( 'Print', 'easytimetable-responsive-schedule-management-system' ); ?></label>
					...
					<div class="forminput">
						...
						<textarea form="newone" id="rows_name" rows="2" cols="45" name="rows_name" placeholder="<?php _e( 'Enter names separated by comma, leave empty to use the date system', 'easytimetable-responsive-schedule-management-system' ); ?>"><?php echo $data[0]->rows_name ?></textarea>
					</div>
					<div class="forminput description">
						<div class="labeldecadix">
							<label for="description"><?php _e( 'Description', 'easytimetable-responsive-schedule-management-system' ); ?></label>
						</div>
						<textarea form="newone" id="description" rows="4" cols="45" name="description" ><?php echo $data[0]->description ?></textarea>
					</div>
					<div class="forminput">
						<input id="activities" type="hidden" name="activities" value='<?php echo $activities ?>'>
					</div>
					<div class="forminput">
						<input id="scheduledact" type="hidden" name="scheduledact" value='<?php echo $scheduledacts ?>'>
					</div>
					<div class="forminput">
					...
					<div class="forminput">
						<input id="created_by" type="hidden" name="created_by" value="<?php echo $data[0]->created_by ?>">
					</div>
					<div class="forminput">
						<input id="access" type="hidden" name="access" value="0">
					</div>
			...
			<?php if ($data[0]->type == 0): ?>
				<div class="timetable-container">
			    	...
			    	<div class="variation-option">
			    		...
			    		<div id="add-variation" class="addvariation button"><?php _e( '+', 'easytimetable-responsive-schedule-management-system' ); ?></div>
			    		<div id="prev-variation" data-current="0" class="prevvariation button"><?php _e( 'Previous', 'easytimetable-responsive-schedule-management-system' ); ?></div>
			    		<div id="next-variation" data-current="0" class="nextvariation button"><?php _e( 'Next', 'easytimetable-responsive-schedule-management-system' ); ?></div>
			    	</div>
		    		...
		    		if ($data[0]->activities) {
				    	for ($i = 0 ; $i < $arrayAct_length ; $i++) {
							if ( $i >= 1) {
								...
								$acttitle = rawurldecode(urldecode($decodedAct->{'actname'}));
								?>
								<li id="activity-<?php echo $decodedAct->{'actid'} ?>" data-actincelltext="<?php echo $decodedAct->{'actincelltext'} ?>" data-tooltiptext="<?php echo $decodedAct->{'acttooltiptext'} ?>" data-imgtooltip="<?php echo $decodedAct->{'imgtooltip'} ?>" data-showdesc="<?php echo $decodedAct->{'showdesc'} ?>" data-name="<?php echo $decodedAct->{'actname'} ?>" data-description="<?php echo $decodedAct->{'actdescription'} ?>" data-color="<?php echo $decodedAct->{'actcolor'} ?>" data-overcolor="<?php echo $decodedAct->{'actovercolor'} ?>" data-fontcolor="<?php echo $decodedAct->{'fontcolor'} ?>" data-fontovercolor="<?php echo $decodedAct->{'fontovercolor'} ?>" data-image="<?php echo $decodedAct->{'actimage'} ?>" data-duration="<?php echo $decodedAct->{'actduration'} ?>" data-idacti="<?php echo $decodedAct->{'actid'} ?>" data-merge="<?php echo $decodedAct->{'merge'} ?>" class="activity-<?php echo $decodedAct->{'actid'}?> activity act-<?php echo $decodedAct->{'actid'} ?>" style="background-color:#<?php echo $decodedAct->{'actcolor'} ?>;color:#<?php echo $decodedAct->{'fontcolor'} ?>;">
	            	                <form id="planactform" enctype="application/json">
		            	                <div id="nom" class="sy-name" style="color:#<?php $decodedAct->{'fontcolor'}?>;"><?php echo $acttitle ?><div class="editacti" ></div><div class="deleteacti" ></div></div>
		                                <?php if ((int)$data[0]->type == 1): ?>
		                                    <input id="duree" name="duree" class="sy-duration-blank" style="width:45% !important;" type="text" value ="<?php echo $decodedAct->{'actduration'} ?>">
		                                <?php else: ?>
		                                    <input id="duree" name="duree" type="hidden" value ="<?php echo $decodedAct->{'actduration'} ?>">
		                                    <div id="duration" class="duration"><?php echo $decodedAct->{'actduration'} ?>'</div>
		                                <?php endif ?>
		            	                ...
		            	                <input id="id_activity" name="id_activity" type="hidden" value ="<?php echo $decodedAct->{'actid'} ?>">
		            	                <input id="start_t" name="start_t" type="text" value = "" class="start invisible" placeholder="Début" style="color:#<?php echo $decodedAct->{'fontcolor'} ?>;">
		            	                <span class="invisible to" style="color:#<?php echo $decodedAct->{'fontcolor'} ?>;"> > </span>
		            	                <input id="end_t" name="end_t" type="text" value = "" class="end invisible" placeholder="Fin" style="color:#<?php echo $decodedAct->{'fontcolor'} ?>;">
		                                ...
		                                <div class="sy-mergebutton invisible"></div>
		                            </form>
	            	            </li>
							<?php	
				...
				<div class="thisplanning-<?php echo $variationCount ?>">
					...
					<div class="fullplanning" data-columns="<?php echo $data[0]->rows ?>" data-variation="<?php echo $variationCount ?>" data-id="<?php echo $data[0]->id ?>" data-type="<?php echo $data[0]->type ?>" data-time-mode="<?php echo $data[0]->time_mode ?>" data-display-title="<?php echo $data[0]->display_title ?>" data-display-filters="<?php echo $model[0]->display_filters ?>" data-start-h="<?php echo $data[0]->start_h ?>" data-color="<?php echo $data[0]->cell_color ?>" data-rows="<?php echo $data[0]->rows ?>" data-cells="<?php echo $data[0]->cells ?>" data-height="<?php echo $data[0]->height ?>" data-column-names="<?php echo $data[0]->rows_name ?>">
						<h3><?php _e( 'Schedule ', 'easytimetable-responsive-schedule-management-system' ); ?><?php echo ($variationCount + 1) ?></h3>
						<?php $rows = $data[0]->rows;
		   				$rwidth= 95/$rows;
		   				// Custom names si le champs est rempli
							   			...
							   			<?php if ($data[0]->scheduledact) { ?> 
											<?php for ($i = 0 ; $i < $arrayplanAct_length ; $i++) {
												...
												if ((int)$decodedplanAct->{'id_cell'} == (int)$idul) { 
													...
													$acttitle = $decodedAct->{'actname'};
											        
											        if ($data[0]->time_mode == 1)
											        {
											            $timemodeStyle = "twelve";
											            $start = $decodedplanAct->{'start_t'};
											            $end = $decodedplanAct->{'end_t'};
											        }
											        else {
											        ...
											        <li id="act-<?php echo $decodedplanAct->{'id_cell'} ?>-<?php echo $actCount ?>-<?php echo $variationCount ?>" data-count="<?php echo $actCount ?>" data-merge="<?php echo $decodedplanAct->{'merge'} ?>" class="act-<?php echo $decodedplanAct->{'id_cell'} ?>-<?php echo $actCount ?>-<?php echo $variationCount ?> activite" style="background-color:#<?php echo $decodedAct->{'actcolor'} ?>;color:#<?php echo  $decodedAct->{'fontcolor'} ?>;">
												        <a class="supprimer-<?php echo $decodedplanAct->{'id_cell'} ?> del" data-showdesc="<?php echo $decodedplanAct->{'showdesc'} ?>" data-idacti="<?php echo $decodedplanAct->{'idacti'} ?>" data-idcell="<?php echo $decodedplanAct->{'id_cell'} ?>" style="display: inline-block;"><script type='text/javascript'>jQuery(document).ready(function(){
												        	jQuery('.supprimer-<?php echo $decodedplanAct->{'id_cell'} ?>').click(function() {
																...
																//alert(JSON.stringify(planActData));
														        	...
														        	if (j < planActsCount) 
														        	{
																		...
																		jQuery('.fullplanning').find('li').each(function()
																		{
														        			...
														        			if (jQuery(this).find('#dateid').val() == planActivityJSON["timetables"][dataVariation]["scheduledacts"][i]["dateid"]) {
														        				console.log(planActivityJSON["timetables"][dataVariation]["scheduledacts"][i]["idacti"]);
														        				console.log(planActivityJSON["timetables"][dataVariation]["scheduledacts"][i]["dateid"]);
														        				console.log(jQuery(this).find('#idacti').val());
												        ...
												        <div id="nom" class="sy-name" title="<?php echo $acttitle ?>"><?php echo urldecode($acttitle) ?></div>
												        <fieldset>
													        <input id="duree" name="duree" type="hidden" value ="<?php echo $decodedplanAct->{'duree'} ?>">
													        <input id="title" name="title" type="hidden" value = "<?php echo $acttitle ?>">
													        <input id="idacti" name="idacti" type="hidden" value ="<?php echo $decodedplanAct->{'idacti'} ?>">
													        <input id="nom" name="nom" type="hidden" value = "<?php echo $acttitle ?>">
													        <input id="id_cell" name="id_cell" type="hidden" value = "<?php echo $decodedplanAct->{'id_cell'} ?>">
													        <input id="id_activity" name="id_activity" type="hidden" value ="<?php echo $decodedplanAct->{'id_activity'} ?>">
													        <input id="start_t" name="start_t" type="text" value = "<?php echo $start ?>" class="start <?php echo $timemodeStyle ?>" style="color:#<?php  echo $decodedAct->{'fontcolor'} ?>;">
													        <span style="color:#<?php echo  $decodedAct->{'fontcolor'} ?>;"> > </span>
													        <input id="end_t" name="end_t" type="text" value = "<?php echo $end ?>" class="end <?php echo $timemodeStyle ?>" style="color:#<?php echo $decodedAct->{'fontcolor'} ?>;">
													        <input id="status" name="status" type="hidden" value="<?php echo $decodedplanAct->{'print'} ?>">
													        <input id="htomove" name="htomove" type="hidden" value="<?php echo $start ?>">
													        <input id="dateid" name="dateid" type="hidden" value="<?php echo $decodedplanAct->{'dateid'} ?>">
													        <input id="merge" name="merge" type="hidden" value="<?php echo $decodedplanAct->{'merge'} ?>">
												    	</fieldset>
												    	<div class="sy-mergebutton"></div>
												    </li>
			...
			<?php endforeach ?>
				<div class="sy-text-script">
					...
					<div class="sy-manage-days"><?php _e( 'Manage days', 'easytimetable-responsive-schedule-management-system' ); ?></div>
					<div class="sy-text-column"><?php _e( 'Column', 'easytimetable-responsive-schedule-management-system' ); ?></div>
					...
					<div class="sy-easy-helptootip"><?php _e( 'Insert html very carefully! <br> Be sure to close your tags<br>Use "<xmp><br></xmp>" to insert single break line', 'easytimetable-responsive-schedule-management-system' ); ?></div>
					<div class="sy-easy-helpdescription"><?php _e( 'Insert html very carefully!<br> Be sure to close your tags<br>Use "<xmp><br></xmp>" to insert single break line', 'easytimetable-responsive-schedule-management-system' ); ?></div>
					<div class="sy-easy-helptextincell"><?php _e( 'Will be displayed only if <br>there is enough place in the activity\'s cell<br>(adjust cell\'s height in "Timetable configuration" if needed)<br>Insert html very carefully! <br> Be sure to close your tags<br>Use "<xmp><br></xmp>" to insert single break line', 'easytimetable-responsive-schedule-management-system' ); ?></div>
		...
		jQuery(document).ready(function($){
			...
			var varLimit = parseInt(jQuery(".fullplanning").length);
			if (jQuery(".fullplanning").length > 1)
			{
				jQuery(".timetable-container").find(".fullplanning").each(function()
				{
					idPlanning = parseInt(jQuery(this).attr("data-variation"));
					if (idPlanning != 0)
					{
						jQuery(this).hide();
					}
			...
			jQuery(".nextvariation").click(function(){
				//jQuery(".thisplanning-0").html(planning_1);
				if (parseInt(jQuery(this).attr("data-current")) < (varLimit-1))
				{
					var currentVar = parseInt(jQuery(this).attr("data-current"));
					var nextVar = currentVar + 1;
					jQuery(".thisplanning-" + currentVar).find(".fullplanning").hide();
					jQuery(".thisplanning-" + nextVar).find(".fullplanning").show();
					jQuery(this).attr("data-current", nextVar);
					jQuery(".prevvariation").attr("data-current", nextVar);
				}
			})
			jQuery(".prevvariation").click(function(){
				if (jQuery(this).attr("data-current") > 0)
				{
					var currentVar = parseInt(jQuery(this).attr("data-current"));
					var prevVar = currentVar - 1;
					jQuery(".thisplanning-" + currentVar).find(".fullplanning").hide();
					jQuery(".thisplanning-" + prevVar).find(".fullplanning").show();
					jQuery(this).attr("data-current", prevVar);
					jQuery(".nextvariation").attr("data-current", prevVar);
				}
			})
			function hastobesaved() {
				if (!jQuery('.ultimate-submit').hasClass('hastobesaved')) {
			...
			jQuery(".timetable-container").find('.fullplanning').each(function(){
				...
				jQuery(this).find("ul").on("sortstart", function (event, ui){
			...
			jQuery(".timetable-container").find('.fullplanning').each(function(){
				...
				jQuery(this).find('.creneau').each(function(){
				...
				jQuery(this).find("li").each(function(){
					var isMerged = jQuery(this).attr('data-merge');
					if (isMerged == 1 && jQuery(this).parent('ul').find('li').length == 1) {
						jQuery(this).parent('ul').removeClass('onlyone');
					}
					...
					var nomActiviteGlobal = jQuery(this).attr('id'); //jQuery(this).find("#title").val()+'_'+number;
				...
				jQuery(this).find('.start').datetimepicker({
				  	...
				  	onSelectTime:function(ct){
				  		...
				  		var duree = parseInt(jQuery(startId).find('#duree').val());
				  		console.info("line 1214 : " + duree);
				  		console.info("line 1215 : " + startId);
				  		console.info("line 1216 : " + jQuery(startId).find('.start').val());
				  		var heureDebut = jQuery(startId).find('.start').val();
				  		console.info("line 1215 : " + heureDebut);
				  		var getH = parseInt(heureDebut.substr(0,2));
						...
						console.log("line 1241 : " +jQuery(this).val());
			  			console.log("line 1242 : " +heureFinal);
				...
				jQuery(this).find('.end').datetimepicker({
				  format:'H:i',
				  step:5,
				  closeOnTimeSelect:true,
				  onShow:function( ct ){ 
		...
		//  Merge function
			...
			function bemerged() {
				jQuery('.creneau').find('li').each(function(){
					var dataVariation = jQuery(this).parents('.fullplanning').attr('data-variation');
					var linumber = jQuery(this).parent('ul').find("li").length;
					// si cellule double
					if (jQuery(this).attr('data-merge') == 1)
					{	
						// Et on supprime la class onlyone à la ul pour pouvoir insérer une activité supplémentaire
						//On change la class du bouton pour afficher le bon picto
						jQuery(this).find('.sy-mergebutton').removeClass('sy-mergebutton');
						...
						if (jQuery(this).find('.sy-name').text().length > 10) {
							var smallName = jQuery(this).find('.sy-name').text().substr(0,10) + "...";
							jQuery(this).find('.sy-name').text(smallName);
						}
						// au clic redevient simple
						jQuery(this).find('.sy-mergebutton2').on('click', function(){

							// On ajoute la valeur '1' au champ #merge et à data-merge
							jQuery(this).parent('li').attr('data-merge', 0);
							jQuery(this).parent('li').find('#merge').val(0);
							
							// On ajoute la class sy-doubleclass à la li
							jQuery(this).parent('li').removeClass('sy-doubleclass');
							// Et on supprime la class onlyone à la ul pour pouvoir insérer une activité supplémentaire
							jQuery(this).parents('.creneau').addClass('onlyone');
							jQuery(this).parent('li').find('.sy-name').css('font-size', '12px');
							jQuery(this).parent('li').css('width', '100%');
							// On réduit la taille du nom pour que ça rentre
							if (jQuery(this).parent('li').find('.sy-name').text().length > 20) {
								var smallName = jQuery(this).parent('li').find('.sy-name').text().substr(0,20) + "...";
								jQuery(this).parent('li').find('.sy-name').text(smallName);
							}

							//On change la class du bouton pour afficher le bon picto
							jQuery(this).addClass('sy-mergebutton');
							jQuery(this).removeClass('sy-mergebutton2');
							

							// on ajoute float left à la première
							if (jQuery(this).parent('li').index() == 0) {
								jQuery(this).parent('li').css('float', 'left');
							}
						})// fin clic mergebutton2
					}
					// Si cellule simple
					else {
						// au clic devient double
						jQuery(this).find('.sy-mergebutton').on('click', function(){

							// On ajoute la valeur '1' au champ #merge et à data-merge
							jQuery(this).parent('li').attr('data-merge', 1);
							jQuery(this).parent('li').find('#merge').val(1);
							
							// On ajoute la class sy-doubleclass à la li
							jQuery(this).parent('li').addClass('sy-doubleclass');
							// Et on supprime la class onlyone à la ul pour pouvoir insérer une activité supplémentaire
							jQuery(this).parents('.creneau').removeClass('onlyone');
							jQuery(this).parent('li').find('.sy-name').css('font-size', '10px');
							jQuery(this).parent('li').css('width', '50%');
							// On réduit la taille du nom pour que ça rentre
							if (jQuery(this).parent('li').find('.sy-name').text().length > 9) {
								var smallName = jQuery(this).parent('li').find('.sy-name').text().substr(0,9) + "...";
								jQuery(this).parent('li').find('.sy-name').text(smallName);
							}
							//On change la class du bouton pour afficher le bon picto
							//jQuery(this).addClass('sy-mergebutton2');

							// on ajoute float left à la première
							if (jQuery(this).parent('li').index() == 0) {
								jQuery(this).parent('li').css('float', 'left');
							}
							var planactId = jQuery(this).parent('li').find('#idacti').val();
				        	...
				        	if (typeof planactId === "undefined") 
				        	{
				        		planactId = jQuery(this).find('#idacti').val();	
				        	}
				        	planActivityJSON['timetables'][dataVariation]['scheduledacts'][planactId]['merge'] = jQuery(this).parent('li').find('input#merge').val();
						        	
				        	//On ajoute la string complète à l'input
			            	jQuery('#scheduledact').val(JSON.stringify(planActivityJSON));
			            	//****************Fin enregistrement de l'activité**********************
			            	hastobesaved();
						})// fin clic mergebutton
					}
				})
			}
			// Fin merge function
		...
		jQuery(".timetable-container").find('.fullplanning').each(function(){
			...
			jQuery(this).sortable({
			    ...
			    receive: function(event, ui){
					...
					// Début Merge function
		            function bemergedDrop(thisli) {
		            	console.log(thisli);
						thisli.each(function(){
							var linumber = thisli.parent('ul').find("li").length;
							console.log(linumber);
							// si cellule double
							if (thisli.attr('data-merge') == 1)
							{	
								// Et on supprime la class onlyone à la ul pour pouvoir insérer une activité supplémentaire
								//console.log(jQuery(this).prev().attr('id'));
								//console.log(jQuery(this).attr('id'));
								//On change la class du bouton pour afficher le bon picto
								thisli.find('.sy-mergebutton').removeClass('sy-mergebutton');
								thisli.addClass('sy-doubleclass');
								
								// on ajoute float left à la première
								if (thisli.index() == 0) {
									thisli.css('float', 'left');
								}
								// et float right à la deuxième
								else 
								{
									thisli.css('float', 'right');
								}
								// On réduit la taille du nom pour que ça rentre
								if (thisli.find('.sy-name').text().length > 10) {
									var smallName = thisli.find('.sy-name').text().substr(0,10) + "...";
									thisli.find('.sy-name').text(smallName);
								}
								// au clic redevient simple
								thisli.find('.sy-mergebutton2').on('click', function(){
							...
							// Si cellule simple
								...
								// au clic devient double
								thisli.find('.sy-mergebutton').on('click', function(){

									// On ajoute la valeur '1' au champ #merge et à data-merge
									thisli.attr('data-merge', 1);
									thisli.find('#merge').val(1);
									
									// On ajoute la class sy-doubleclass à la li
									thisli.addClass('sy-doubleclass');
									// Et on supprime la class onlyone à la ul pour pouvoir insérer une activité supplémentaire
									thisli.parents('.creneau').removeClass('onlyone');
									//thisli.find('.name').css('font-size', '10px');
									thisli.css('width', '50%');
									// On réduit la taille du nom pour que ça rentre
									if (thisli.find('.sy-name').text().length > 9) {
										var smallName = thisli.find('.sy-name').text().substr(0,9) + "...";
										thisli.find('.sy-name').text(smallName);
									}
									//On change la class du bouton pour afficher le bon picto
									//jQuery(this).addClass('sy-mergebutton2');
									jQuery(this).removeClass('sy-mergebutton');
									...
									var planactId = thisli.find('#idacti').val();
									//On récupère en JSON les donnée de input#scheduledact
									var planActData = getPlanActData(dataVariation);
									//console.log(planActData[0]);
									var planActivityJSON = planActData[0];
						        	...
						        	if (typeof planactId === "undefined") 
						        	{
						        		planactId = thisli.find('#idacti').val();
						        	}
						        	planActivityJSON['timetables'][dataVariation]['scheduledacts'][planactId]['merge'] = thisli.find('input#merge').val();
					...
					jQuery(this).find("li").each(function(){
						...
						//On enlève l'icone de suppression de l'activité
						...
						if (numberOfItem == 0 || numberOfItem == 2 || (numberOfItem == 3 && typeof alreadyThere === "undefined")) {
							...
							if (jQuery(this).prev().find('#merge').val() == 1) {
								...
								// On réduit la taille du nom pour que ça rentre
								if (jQuery(this).find('.sy-name').text().length > 9) {
									var smallName = jQuery(this).find('.sy-name').text().substr(0,9) + "...";
									jQuery(this).find('.sy-name').text(smallName);
								}
							}
							else {
							...
							/*****************************************************************/
					            ...
					            if (senderId) {
									...
									//alert("dataVariation 2497" + dataVariation);
...
/**************************************************************/
        ...
        var textCreate = jQuery('.sy-text-create').text();
        var textClose = jQuery('.sy-text-close').text();
        var textApply = jQuery('.sy-text-apply').text();
        // Option pour la création d'une nouvelle activité
        var opt = {
            dialogClass: "no-close",
            closeOnEscape: false,
            autoOpen: false,
                ...
                click: function() {
                	...
                	if (name != "blank") {
						jQuery( "#theactivities" ).append( 
							'<li id="'+newid+'" data-merge="" data-idcell="" class="'+newid+idActivity+' activity ui-draggable ui-draggable-handle act-'+'" style="background-color:#'+color+';color:#'+fontcolor+';margin-left: 3px;">'+
        ...
        jQuery(".deleteacti").on( "click", function() {
        	...
        	var currentSchedule = jQuery("#prev-variation").attr("data-current");
	        var actli = jQuery(this).parents('li');
	        
	        var idacti = actli.attr('data-idacti');
	        var idname = decodeURIComponent(actli.attr('data-name'));
	        
	        var thedata = JSON.parse(jQuery("#scheduledact").val())
	        var textDeleteOpt = jQuery('.sy-option-to-delete').html();
    		var deleteinfo = "<div class='sy-delete-act'>";
    		deleteinfo = deleteinfo +"<div class='sy-delete-info' data-id='" + idacti + "'>";
    		deleteinfo = deleteinfo +"<h3 class='sy-delete-dialog-content'> " + textDeleteOpt + " \"" + idname +"\"";
        ...
        var editactopt = {
            ...
            buttons: [
            {
                ...
                click: function() {
                	...
                	// ON récupère les datas du formulaire transformé en string json
                	//console.log("serialize data : " + jQuery('#actiform').serializeObject());
		        	var thisActivity = JSON.stringify(jQuery('#actiform').serializeObject());
		        	// On transform le string en objet JSON
		        	var thisActivityJson = JSON.parse(thisActivity);
		        	// On récupère l'id de la nouvelle activité
		        	var idActivity = thisActivityJson['actid'];
		        	var duration = thisActivityJson['actduration'];
		        	//console.log('actnamenew : ' + thisActivityJson['actnamenew']);
		        	//console.log('actname : ' + thisActivityJson['actname']);
		        	...
		        	thisActivityJson['actdescription'] = resdesc;
		        	thisActivityJson['actincelltext'] = restextcell;
		        	//console.log(thisActivityJson['acttooltiptext']);
		        	var oldActiJson = JSON.parse(activityArray[idActivity]);
		        	//console.log(oldActiJson);
        ...
        jQuery(".editacti").on( "click", function() {
	        ...
	        editactivity +=    '<h3>' + editText + ' ' + decodeURIComponent(name) + '</h3>';
	        ...
	        editactivity +=                '<input id="actduration" type="number" name="actduration" value="' + duration + '">';
	        editactivity +=            '</div>';
	        ...
	        editactivity +=            '</div>';
	        editactivity +=            '<div class="sy-help"><!--<img class="sy-helpimage" src="wp-content/plugins/easy-timetable/admin/images/question-mark.png" title="Complete all fields">--></div>';   
	        editactivity +=            '<label for="actstatus" ></label>';
	        editactivity +=            '<input id="actstatus" type="hidden" value="1" name="actstatus">';
	        editactivity +=           '<!-- Allow form submission with keyboard without duplicating the dialog button -->';
	        editactivity +=           '<!--<input id="et_save_act" type="submit" value="save">-->';
        ...
        jQuery( "#create" ).on( "click", function() {
	        ...
	        newactivity +=                 '<input id="actduration" type="number" name="actduration" value="60">';
	        newactivity +=             '</div>';
	        ...
	        newactivity +=                     '<input id="actovercolor" class="sy-colorfield" type="text" value="ccff00" name="actovercolor"> ' ; 
	        newactivity +=                     '<div class="sy-showcolor" style=""></div>'; 	        
	        newactivity +=               '</div>';
	        ...
	        newactivity +=             '</div>';
	        newactivity +=             '<div class="sy-help"><!--<img class="sy-helpimage" src="wp-content/plugins/easy-timetable/admin/images/question-mark.png" title="Complete all fields">--></div>';   
	        newactivity +=             '<label for="actstatus" ></label>';
	        newactivity +=             '<input id="actstatus" type="hidden" value="1" name="actstatus">';
	        newactivity +=            '<!-- Allow form submission with keyboard without duplicating the dialog button -->';
	        newactivity +=            '<!--<input id="et_save_act" type="submit" value="save">-->';
		...
		jQuery( "#sydays" ).on( "click", function() {
			...
			var syColumnText = jQuery(".sy-text-column").text();
			// nombre des jours (nombre de colonnes)
			for (var j = 0; j < numberOfDays; j++) 
			{
				dayz += '<div class="sy-a-day">';
				dayz += syColumnText + ' ' + (j+1) + " ";
			...
			dayz += '</div>';
			var ManageDays = jQuery(".sy-manage-days").text();
        	// On créé le formulaire
        	var newday = '<div id="day-form" class="sy-day-form" class="">';
        	newday +=   '<h3>' + ManageDays + '</h3>';
            ...
            buttons: [
	            {
	            	...
	            	click: function(){
	            		...
	            		//console.log(scheduledact['timetables'][dataVariation]['weeks']);
	            		//console.log(theseDays);
	...
	var emptySchedule = jQuery(".sy-empty-schedule").text();
	var copyCurrent = jQuery(".sy-copy-current").text();
		var addVariationOpt = 
		{
        	dialogClass: "no-close",
            closeOnEscape: false,
            ...
            buttons: [
	            {
	            	...
	            	click: function(){
			        	...
			        	var vNo = parseInt(jQuery(".nextvariation").attr("data-current"));
						//console.info(vNo);
						var countObject = Object.keys(thisdata['timetables']).length;
						var toCopy = thisdata['timetables'][vNo];
						thisdata['timetables'][countObject] = toCopy;
						jQuery('#scheduledact').val(JSON.stringify(thisdata));
						
	            		jQuery(".sy-addvariation-form").remove();
	                	jQuery(this).dialog("destroy");
	                	function hastobesaved() {
							if (!jQuery('.ultimate-submit').hasClass('hastobesaved')) {
								jQuery('.ultimate-submit').addClass('hastobesaved');
	            ...
	            },
	            {
	            	...
	            	click: function(){
						...
						//console.info(vNo);
						var countObject = Object.keys(thisdata['timetables']).length;
						var toCopy = JSON.parse('{"scheduledacts":{},"weeks":{}}');
						//console.info(toCopy);
						thisdata['timetables'][countObject] = toCopy;
						//console.info(thisdata['timetables']);
						jQuery('#scheduledact').val(JSON.stringify(thisdata));
            ...
            open:function () {
            	jQuery(".ui-dialog ").addClass("syet-dialog");
		        jQuery(".ui-dialog ").find(".ui-dialog-buttonset").find(".ui-button:first").addClass("sy-apply");
		        jQuery(".ui-dialog ").find(".ui-dialog-buttonset").find(".ui-button:eq(1)").addClass("sy-empty");
		        jQuery(".ui-dialog ").find(".ui-dialog-buttonset").find(".ui-button:last").addClass("sy-cancel");
		    },
		    classes: {
			  "ui-dialog": "highlight"
        ...
        var scheduleVar = jQuery( ".sy-new-schedule-variation" ).text();
        var pleaseChoose = jQuery( ".sy-please-choose" ).text();
        jQuery( "#add-variation" ).on( "click", function() {  
        	var variationform = "<div class='sy-addvariation-form'>";  	
        	variationform += "<h1>"+scheduleVar+"</h1>";  	
        	variationform += "<p>"+pleaseChoose+"<p>";  	
        	variationform += "</div>";  	
        	jQuery('#addvariationform').html('');
	        if (jQuery('#addvariationform').html() == '')	{
	        	// On ajoute le formulaire à la div qui s'ouvre en dialog box
	        	jQuery('#addvariationform').append(variationform);
	        }
	        var addVarDialog = jQuery("#addvariationform").dialog(addVariationOpt);
        	addVarDialog.dialog('open');
        }); //Fin add-variation button click
		</script>
		<?php
	}
	...
	{
		echo $id;
		//$menuItem = EasyTimetableModelCreate::editMenu($id[0]->id);
